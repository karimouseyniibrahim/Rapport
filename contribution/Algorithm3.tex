...
\SetKwFunction{printlcs}{getSucc}
\begin{algorithm}[H]
 \SetAlgoLined\DontPrintSemicolon
  \SetKwFunction{algo}{\printlcs{$e:State$}: List of State}\SetKwFunction{proc}{proc}
  \SetKwProg{myalg}{Fuction}{}{}
  \myalg{\algo{}}{
  \nl$ElementSucc	\longleftarrow\emptyset$\;
  \nl\ForEach{$e'\in succ(e)$}{ \label{linef1}
  \nl		\If{$((e'\nexists e.f)and((e'.f\cap e.f)\ne\emptyset)$ }{\label{linef2}
  \nl 		 	$ElementSucc\longleftarrow ElementSucc\cup\{e'\}\cup \printlcs{e'}$\;\label{linef3}
  \nl 		}
  \nl 	}
  \nl 	
  \nl \KwRet ElementSucc \;\label{linef4}}{}
\end{algorithm}
...
\ForEach{$e$ in $S$}{\label{line42}
	...
	\uElseIf{$\left((e  \in Notifier(M))and (e\in T) and (\curenti{}\in e.i)\right)$}{\label{line49}
		$e.\parametretwo{} \longleftarrow getSucc(Count\parametretwo{}(e))+1$\;\label{line410}
		\ForEach{$e" \in e.f$}{\label{line411}
					\If{$\left( (Type(e") \ne Border\right)$}{\label{line415}
