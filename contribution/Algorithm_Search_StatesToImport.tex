...
\nl			}\label{linerI10}
	...
	\caption{$Search\_ Min\_ States\_DeplaceOnDistantMachine$():state}\label{Search2}
\end{function}


Les instructions décrivant la fonction \ref{Search2} sont expliquées comme suit:
\begin{description}
