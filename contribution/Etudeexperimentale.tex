...
\def\lasty{}
		\begin{tikzpicture}
		\draw[thick,<->] (0,8) node[right]{Temps d'exécution}--(0,0)--(14,0) node[below]{Formule CTL};
		\draw [blue](0,5)--(2,5);
		\draw [blue](2,7)--(3,7);
		\draw [blue](3,4)--(5,4);
		\draw [blue](5,3)--(8,3);
		...
		\end{tikzpicture}
			\begin{figure}[h]
			\caption{Temps d'exécution des formules CTL en fonction des améliorations}\label{resultatcourbe}
		\end{figure}
\section{Discussion}
