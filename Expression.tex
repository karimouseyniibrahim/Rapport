...
\title{Développement d'approche de distribution des espaces d'états basée  sur la théorie de jeux: \LARGE\textcolor{red}{ Application au model checking distribué}}
