...
\input{theorie_graphe/Notions_mathematiques}
\input{theorie_graphe/Optimisation_combinatoire}
\input{theorie_graphe/Notions_graphe}
\input{theorie_graphe/Notions_theoriejeux}
\input{theorie_graphe/Methode_partitionnement}
\input{theorie_graphe/Approches_partitionnement}
\input{theorie_graphe/Distribution_graphes}
\section{Conclusion}{
